...
public class PlaybackControlsFragment extends Fragment {
    ...
    private void onMetadataChanged(MediaMetadataCompat metadata) {
        ...
        if (Global.gIsRemote == false) {
            mAlbumArt.setImageResource(R.drawable.local_bg);
            return;
        }
        String artUrl = null;
    ...
    private void playMedia() {
        ...
        if (controller != null) {
            ...
            //在原版代码中，exoplayer2应该是是controller有某种联系的，故而此处直接调用的controller的paly方法
            //就可以使得exoplayer2也开始播放。然而我改用MediaPlayer后，它与controller没有此种联系，故而音乐没有
            //从pause态转到play态。故而此处需添加以下代码：
