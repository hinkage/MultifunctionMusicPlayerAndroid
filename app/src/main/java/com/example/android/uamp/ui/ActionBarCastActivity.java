            ...
            if (mItemToOpenWhenDrawerCloses >= 0) {
                ...
                switch (mItemToOpenWhenDrawerCloses) {
                    case R.id.navigation_allmusic:
                        Global.gIsRemote = false;
                        // 每次创建更新一下source
                        //MusicService.mMusicProvider = new MusicProvider();
                        //这种方法只更新了Service里的static的Provider，没有更新Queue里的Provider，所以网络切换会出错
                        if (Global.gMusicService != null) {
                            Global.gMusicService.switchSource(false);
                        }
                    ...
                    case R.id.navigation_playlists:
                        ...
                        //MusicService.mMusicProvider = new MusicProvider();
                        if (Global.gMusicService != null) {
                            Global.gMusicService.switchSource(true);
                        }
