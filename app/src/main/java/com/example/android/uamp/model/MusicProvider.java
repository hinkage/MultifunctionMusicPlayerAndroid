...
public class MusicProvider {
    ...
    public void switchSource(boolean isRemote) {
        ...
        this.mFavoriteTracks.clear();
        this.mCurrentState = State.NON_INITIALIZED;

        if (isRemote) {
            mSource = new RemoteJSONSource();
        }
        else {
            mSource = new LocalSource();
        }
    ...
    /*public void changeSource() {
        ...
        this.mMusicListByGenre.clear();
        this.mMusicListById.clear();
        this.retrieveMediaAsync(null);
    }*/
    public MusicProvider(boolean isRemote) {
        if (isRemote) {
            mSource = new RemoteJSONSource();
        }
        else {
