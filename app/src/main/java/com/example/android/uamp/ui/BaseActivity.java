...
import com.example.android.uamp.utils.ShakeDetector;
...
public abstract class BaseActivity extends ActionBarCastActivity implements MediaBrowserProvider {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShakeDetector.registerOnShakeListener(new ShakeDetector.OnShakeListener() {
            @Override
            public void onShake() {
                Toast.makeText(getApplicationContext(), "Detected shake", Toast.LENGTH_SHORT).show();
                if (isConnected == true) {
