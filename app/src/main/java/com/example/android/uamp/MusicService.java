...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public void switchSource(boolean isRemote) {
        //Global.gIsRemote = isRemote;
        mMusicProvider.switchSource(isRemote);
        ...
        //mPlaybackManager.switchSource(mMusicProvider);
    ...
    public void onCreate() {
        ...
        Global.gMusicService = this;

        mMusicProvider = new MusicProvider(Global.gIsRemote);
